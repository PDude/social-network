        ...
        <div className={style.avatar_info}>
            ...
            <Container>
                ...
                {editMode
                    ...
                    : <ProfileData profile={profile} isOwner={isOwner} editModeTurnOn={() => { setEditMode(true) }}>
    ...
    return (
        <div className={style.profile_desc}>
            <div className={style.full_name_and_edit}>
                ...
                {isOwner && <button onClick={editModeTurnOn} className={style.edit_mode_btn}>edit</button>}
            </div>
            {/* Status */}
            {props.children}
            {/* Status */}
